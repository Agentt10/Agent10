...
const Home5 = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await fetch("https://69f9fc83c509a40d3aa3af57.mockapi.io/credentials", {
        method: "POST",
  ...
  return (
    ...
    <div className="sm:flex h-full w-full bg-t-white text-gray-900 font-sans overflow-hidden">
      ...
      <div className="w-full lg:w-[40%]  p-14 to-blue-50 bg-gradient-to-br p-12 flex flex-col justify-between">
        <div>
        ...
        <div className="max-w-xl mx-auto w-full">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="pt-4">
              <button
                type="submit"
                className="w-full bg-[#2a2fb9] hover:bg-blue-700 text-white py-4 rounded-full font-bold text-lg shadow-xl shadow-blue-100 transition-all active:scale-95"
              >
                Continue
              </button>
            </div>
