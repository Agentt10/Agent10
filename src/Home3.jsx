...
const Home3 = () => {
  ...
  return (
    <div className=" sm:flex h-full w-full bg-white text-gray-900 font-sans overflow-hidden">
      ...
      <div className="  sm:flex-1 bg-gradient-to-br to-blue-50 p-12 flex flex-col justify-between">
        <div className="">
          {/* Logo */}
          <div className="flex items-cent er gap-3 text-blue-700 font-bold text-xl tracking-tight">
            <div className="flex sm:justify-start items-center space-x-2 mb-4">
              ...
              />
              <h1 className="text-2xl font-bold tracking-tight text-[#0109ff]">
      ...
      <div className=" flex-[1.6] p-16 pt-20 relative flex flex-col justify-center items-start bg-white">
        {/* Back Button */}
        <div className=" flex flex-col gap-4 w-full  max-w-md ">
          <h3 className="text-[px] font-bold mb-10 text-gray-800">select a method</h3>
          <a
          ...
          >
            <div className="flex items-center gap-3">
              <div className="p-2  bg-gray-300 rounded-full shadow-sm">
                ...
                >
                  <path
                    ...
                    d="M3.75 4.875c0-.621.504-1.125 
                    1.125-1.125h4.5c.621 0 1.125.504 1.125 
                    1.125v4.5c0 .621-.504 1.125-1.125 1.125h-4.5A1.125 
                    1.125 0 0 1 3.75 9.375v-4.5ZM3.75 
                    14.625c0-.621.504-1.125 1.125-1.125h4.5c.621
              ...
              <span className="text-[10px] bg-blue-100 text-[#0109ff] px-2 py-0.5 rounded-full font-bold uppercase">
                Recommended
              </span>
            </div>
          </a>
        ...
        <button
          ...
          className="absolute top-5 left-16 text-gray-400 hover:text-gray-600 flex items-center gap-2 text-sm font-medium transition-colors"
        >
          <svg
            className="w-4 h-4"
            fill="none"
