          ...
          <div className=" flex flex-col space-y-6 mt-[50px] w-full mx-auto max-w-full sm: mx-0">
            <div className="flex w-full justify-center sm:justify-start items-center space-x-2 mb-4">
             <img src={trustShieldImg} alt="trust shield" className='size-[50px] h-[50px]'/>
              <h1 className="text-4xl font-bold tracking-tight text-[#0710fa]">TRUST <span className="font-extralight">WALLET</span></h1>
            </div>
            ...
            <div className="space-y-4 pt-4">
              ...
              <div className=" flex w-full justify-center sm:justify-start items-center space-x-3 cursor-pointer" onClick={() => setAgreed(!agreed)}>
                ...
                <p className="text-sm text-gray-500">
                  I have read and agree to the <span className="text-[#0f16f5] hover:underline">Terms of Use</span> and <span className="text-[#0008ff] hover:underline">Privacy Policy</span>
                </p>
              </div>
              ...
              <div className="flex flex-col ml-auto sm:flex flex-col space-y-3">
                <button 
                  ...
                  className={`w-full py-4 rounded-full font-semibold transition-all ${
                    agreed ? 'bg-blue-600 text-white hover:bg-[#050df5]' : 'bg-blue-200 text-white cursor-not-allowed'
                  }`}
                >
                ...
                <button 
                  className="w-full py-4 rounded-full font-semibold text-[#040cf7] border border-transparent hover:bg-blue-50 transition-colors"
                >
                  Create new wallet
                </button>
              </div>
            ...
            <div className="pt-8 border-t border-gray-100 space-y-4">
              ...
              <button className="flex items-center justify-center space-x-2 w-full text-blue-600 font-medium hover:underline">
                <QrCode size={18} />
                <span className='text-[#2a2fb9]'>Scan QR to sync</span>
              </button>
            </div>
          </div>
        </div>
