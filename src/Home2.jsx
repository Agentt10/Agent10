...
const Home2 = () => {
  ...
  return (
    <div className="lg:flex h-full w-full bg-white text-gray-900 font-sans overflow-hidden">
      {/* Left Sidebar Section */}
      <div className="lg:flex-1 bg-gradient-to-br to-blue-50 p-12 flex flex-col justify-between">
        <div className="">
          {/* Logo */}
        ...
        <div className="hidden lg:flex mb-[40px] mr-[20px] justify-center opacity-80 transition-all">
          <video
            src={trust}
            autoPlay
            loop
      ...
      <div className=" pt-[]  flex lg:flex-[1.6] p-16 pt-15 relative flex flex-col justify-center items-center bg-white">
        {/* Back Button */}
        <button
          onClick={() => navigate("/")}
          className=" absolute left-16 flex lg:absolute top-5 left-16 text-gray-400 hover:text-gray-600 flex items-center gap-2 text-sm font-medium transition-colors"
        >
          <svg
            className="w-4 h-4"
            fill="none"
        ...
        <div className="w-full max-w-lg">
          <h2 className="text-[20px] font-bold mb-10 text-gray-800">
